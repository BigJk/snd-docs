...
* **Printer Type:**
    ...
    * **Windows Direct Printing:** Select Printer Name ([Setup](https://github.com/BigJk/snd/wiki/Printer-Setup#windows-generic-driver) or install Chinese Driver)
    * **CUPS:** Select Printer Name ([Setup](https://github.com/BigJk/snd/wiki/Printer-Setup#cups-for-linux-mac))
...
* **Printer Type:** Serial
* **Printer Type:**
    * **Windows Direct Printing:** Select Printer Name ([Setup](https://github.com/BigJk/snd/wiki/Printer-Setup#windows-generic-driver))
...
* **Printer Type:**
    ...
    * **Windows Direct Printing:** Untested ([Setup](https://github.com/BigJk/snd/wiki/Printer-Setup#windows-generic-driver))
    * **CUPS:** Select Printer Name ([Setup](https://github.com/BigJk/snd/wiki/Printer-Setup#cups-for-linux-mac))
...
* **Printer Type:**
    * **Raw USB Printing:** Untested
    * **Windows Direct Printing:** Tested ([Setup](https://github.com/BigJk/snd/wiki/Printer-Setup#windows-generic-driver))
    * **CUPS:** Untested ([Setup](https://github.com/BigJk/snd/wiki/Printer-Setup#cups-for-linux-mac))
...
* **Printer Type:**
    * **Raw USB Printing:** Untested
    * **Windows Direct Printing:** Unknown
    * **CUPS:** Untested
